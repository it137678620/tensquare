...
public class ProblemController {
    ...
    public Result<PageResult> findNewListByLabelId(@PathVariable("labelid") String labelid, @PathVariable("page") int page, @PathVariable("size") int size) {
    ...
    public Result<PageResult> findHotListByLabelId(@PathVariable("labelid") String labelid, @PathVariable("page") int page, @PathVariable("size") int size) {
    ...
    public Result<PageResult> findWaitListByLabelId(@PathVariable("labelid") String labelid, @PathVariable("page") int page, @PathVariable("size") int size) {
